...
const RECOMMENDED = [
  { id: 1, title: 'Pandavleni Caves', location: 'Nashik, Maharashtra', image: require('../../assets/images/pandavleni.jpg'), difficulty: 'Easy', duration: '2-3 hrs', distance: '0.6 km', elevation: '90 m' },
  { id: 2, title: 'Anjaneri Fort', location: 'Nashik, Maharashtra', image: require('../../assets/images/rajmachi.jpg'), difficulty: 'Moderate', duration: '3-5 hrs', distance: '3.2 km', elevation: '350 m' }, 
  { id: 3, title: 'Dugarwadi Waterfall', location: 'Nashik, Maharashtra', image: require('../../assets/images/kalsubai.jpg'), difficulty: 'Easy', duration: '1-2 hrs', distance: '2.8 km', elevation: '220 m' }
];
    ...
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 120 }}>
        ...
        <View style={styles.continueCardWrapper}>
          <ImageBackground source={require('../../assets/images/pandavleni.jpg')} style={styles.continueCardBg} imageStyle={{borderRadius: 20}}>
            <BlurView intensity={70} tint="dark" style={styles.continueBlur}>
              <View style={styles.continueLeft}>
                <Image source={require('../../assets/images/pandavleni.jpg')} style={styles.continueThumb} />
